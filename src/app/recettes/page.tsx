...
const comparaisonTauxComplete = {
  tfpb: {
    ...
    data: [
      { label: 'Toulouse', value: 48.55, color: '#22496A' },
      { label: 'Bordeaux', value: 48.48, color: '#22496A' },
      { label: 'Marseille', value: 47.13, color: '#22496A' },
      { label: 'Moyenne nationale', value: 39.42, color: '#22496A', subLabel: '(référence)' },
      { label: 'Paris', value: 20.50, color: '#22496A', highlight: true },
    ],
  },
  thrs: {
    label: 'Taxe habitation (rés. secondaires)',
    data: [
      { label: 'Marseille', value: 40.95, color: '#22496A' },
      { label: 'Toulouse', value: 34.75, color: '#22496A' },
      { label: 'Bordeaux', value: 32.35, color: '#22496A' },
      { label: 'Moyenne nationale', value: 24.45, color: '#22496A', subLabel: '(référence)' },
      { label: 'Paris', value: 20.32, color: '#22496A', highlight: true },
    ],
  },
  tfpnb: {
    label: 'Taxe foncière non bâti (TFPNB)',
    data: [
      { label: 'Toulouse', value: 93.49, color: '#22496A' },
      { label: 'Bordeaux', value: 93.24, color: '#22496A' },
      { label: 'Moyenne nationale', value: 50.82, color: '#22496A', subLabel: '(référence)' },
      { label: 'Marseille', value: 27.77, color: '#22496A' },
      { label: 'Paris', value: 25.31, color: '#22496A', highlight: true },
    ],
  },
  cfe: {
    label: 'Cotisation foncière entreprises',
    data: [
      { label: 'Toulouse', value: 36.58, color: '#22496A' },
      { label: 'Bordeaux', value: 35.06, color: '#22496A' },
      { label: 'Marseille', value: 32.87, color: '#22496A' },
      { label: 'Moyenne nationale', value: 26.75, color: '#22496A', subLabel: '(référence)' },
      { label: 'Paris', value: 16.52, color: '#22496A', highlight: true },
    ],
  },
  teom: {
    label: 'Taxe enlèvement ordures (TEOM)',
    data: [
      { label: 'Marseille', value: 18.10, color: '#22496A' },
      { label: 'Bordeaux', value: 9.31, color: '#22496A' },
      { label: 'Moyenne nationale', value: 8.25, color: '#22496A', subLabel: '(référence)' },
      { label: 'Toulouse', value: 8.10, color: '#22496A' },
      { label: 'Paris', value: 6.21, color: '#22496A', highlight: true },
    ],
  },
};
