...
const comparaisonTauxComplete = {
  tfpb: {
    ...
    data: [
      { label: 'Toulouse', value: 48.55, color: '#E1386E' },
      { label: 'Bordeaux', value: 48.48, color: '#E1386E' },
      { label: 'Marseille', value: 47.13, color: '#E1386E' },
      { label: 'Moyenne nationale', value: 39.42, color: '#22496A', subLabel: '(référence)' },
      { label: 'Paris', value: 20.50, color: '#FBCD41', highlight: true },
    ],
  },
  thrs: {
    label: 'Taxe habitation (rés. secondaires)',
    data: [
      { label: 'Marseille', value: 40.95, color: '#E1386E' },
      { label: 'Toulouse', value: 34.75, color: '#E1386E' },
      { label: 'Bordeaux', value: 32.35, color: '#E1386E' },
      { label: 'Moyenne nationale', value: 24.45, color: '#22496A', subLabel: '(référence)' },
      { label: 'Paris', value: 20.32, color: '#FBCD41', highlight: true },
    ],
  },
  tfpnb: {
    label: 'Taxe foncière non bâti (TFPNB)',
    data: [
      { label: 'Toulouse', value: 93.49, color: '#E1386E' },
      { label: 'Bordeaux', value: 93.24, color: '#E1386E' },
      { label: 'Moyenne nationale', value: 50.82, color: '#22496A', subLabel: '(référence)' },
      { label: 'Marseille', value: 27.77, color: '#E1386E' },
      { label: 'Paris', value: 25.31, color: '#FBCD41', highlight: true },
    ],
  },
  cfe: {
    label: 'Cotisation foncière entreprises',
    data: [
      { label: 'Toulouse', value: 36.58, color: '#E1386E' },
      { label: 'Bordeaux', value: 35.06, color: '#E1386E' },
      { label: 'Marseille', value: 32.87, color: '#E1386E' },
      { label: 'Moyenne nationale', value: 26.75, color: '#22496A', subLabel: '(référence)' },
      { label: 'Paris', value: 16.52, color: '#FBCD41', highlight: true },
    ],
  },
  teom: {
    label: 'Taxe enlèvement ordures (TEOM)',
    data: [
      { label: 'Marseille', value: 18.10, color: '#E1386E' },
      { label: 'Bordeaux', value: 9.31, color: '#E1386E' },
      { label: 'Moyenne nationale', value: 8.25, color: '#22496A', subLabel: '(référence)' },
      { label: 'Toulouse', value: 8.10, color: '#E1386E' },
      { label: 'Paris', value: 6.21, color: '#FBCD41', highlight: true },
    ],
  },
};
