...
const politiques = [
  {
    ...
    keyFacts: [
      { label: 'RSA et insertion', value: '461 M€', detail: 'Allocation et accompagnement retour à l\'emploi' },
    ...
    repartition: [
      ...
      { name: 'CASVP et interventions', value: 22.2, color: '#1e3a8a' },
      { name: 'Aide sociale enfance', value: 18.5, color: '#2563eb' },
      { name: 'Handicap', value: 14.6, color: '#3b82f6' },
      { name: 'Personnes âgées', value: 11.5, color: '#60a5fa' },
      { name: 'Crèches', value: 6.6, color: '#93c5fd' },
      { name: 'Autres', value: 4.1, color: '#dbeafe' },
    ],
    projets: [
  ...
  },
  {
    ...
    repartition: [
      ...
      { name: 'Administration générale', value: 35.8, color: '#2563eb' },
      { name: 'Action internationale', value: 0.9, color: '#93c5fd' },
    ],
    projets: [
  ...
  },
  {
    ...
    keyFacts: [
      ...
      { label: 'Plan Vélo', value: '25 M€', detail: '+100 km de pistes livrés depuis 2020' },
      { label: 'Extensions métro/tramway', value: '51 M€', detail: 'RER E Eole, T3b, ligne 14' },
      { label: 'Pass Imagine R', value: '22 M€', detail: 'Remboursement collégiens et lycéens' },
    ],
    ...
    repartition: [
      ...
      { name: 'Voirie communale', value: 14.4, color: '#1e3a8a' },
      { name: 'Transport sur route', value: 5.3, color: '#2563eb' },
      { name: 'Aides transports', value: 3.5, color: '#3b82f6' },
      { name: 'Équipement voirie', value: 1.5, color: '#60a5fa' },
      { name: 'Autres', value: 2.1, color: '#dbeafe' },
    ],
    projets: [
  ...
  },
  {
    ...
    repartition: [
      ...
      { name: 'Collecte déchets', value: 25.8, color: '#1e3a8a' },
      { name: 'Services communs', value: 19.2, color: '#2563eb' },
      { name: 'Propreté urbaine', value: 16.3, color: '#3b82f6' },
      { name: 'Politique eau', value: 5.3, color: '#60a5fa' },
      { name: 'Autres', value: 1.4, color: '#dbeafe' },
    ],
    projets: [
  ...
  },
  {
    ...
    repartition: [
      ...
      { name: 'Sports', value: 21.5, color: '#1e3a8a' },
      { name: 'Jeunesse loisirs', value: 7.0, color: '#2563eb' },
      { name: 'Vie sociale', value: 1.5, color: '#60a5fa' },
      { name: 'Services communs', value: 0.9, color: '#dbeafe' },
    ],
    projets: [
  ...
  },
  {
    ...
    keyFacts: [
      ...
      { label: 'Cours Oasis', value: '7 M€', detail: 'Végétalisation des cours d\'école' },
    ],
    ...
    repartition: [
      ...
      { name: 'Enseignement primaire', value: 18.0, color: '#1e3a8a' },
      { name: 'Enseignement secondaire', value: 17.6, color: '#2563eb' },
      { name: 'Enseignement supérieur', value: 7.8, color: '#3b82f6' },
      { name: 'Formation pro.', value: 2.4, color: '#dbeafe' },
    ],
    projets: [
  ...
  },
  {
    ...
    keyFacts: [
      ...
      { label: 'Éclairage public', value: '33 M€', detail: '-6 M€ grâce à la sobriété énergétique' },
      { label: 'Espaces verts', value: '50 M€', detail: 'Création parcs, forêts urbaines' },
      { label: 'Éco-Rénovons Paris', value: '10 M€', detail: 'Rénovation énergétique copropriétés' },
      { label: 'Embellir votre quartier', value: '15 M€', detail: 'Aménagements de proximité' },
    ],
    ...
    repartition: [
      ...
      { name: 'Opérations aménagement', value: 18.6, color: '#1e3a8a' },
      { name: 'Espaces verts', value: 18.6, color: '#2563eb' },
      { name: 'Habitat logement', value: 16.4, color: '#3b82f6' },
      { name: 'Services communs', value: 7.1, color: '#60a5fa' },
      { name: 'Politique ville', value: 5.4, color: '#dbeafe' },
    ],
    projets: [
      ...
      { nom: 'Embellir votre quartier', montant: 15.0 },
  ...
  },
  {
    ...
    repartition: [
      ...
      { name: 'Brigade pompiers BSPP', value: 40.0, color: '#1e3a8a' },
      { name: 'Police municipale', value: 5.3, color: '#2563eb' },
      { name: 'Services communs', value: 2.1, color: '#dbeafe' },
    ],
    projets: [
  ...
  },
  {
    ...
    repartition: [
      ...
      { name: 'Recherche innovation', value: 17.5, color: '#1e3a8a' },
      { name: 'Commerce artisanat', value: 15.3, color: '#2563eb' },
      { name: 'Tourisme', value: 10.3, color: '#3b82f6' },
      { name: 'Agriculture urbaine', value: 8.2, color: '#60a5fa' },
      { name: 'Autres', value: 13.7, color: '#dbeafe' },
    ],
    projets: [
